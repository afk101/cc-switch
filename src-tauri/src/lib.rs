...
pub fn run() {
    ...
    let builder = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::list_codex_provider_profile_refs,
            commands::enable_codex_profile_route,
            commands::switch_codex_profile_provider,
            commands::disable_codex_profile_route,
...
async fn enabled_proxy_apps_on_startup(db: &database::Database) -> Vec<crate::app_config::AppType> {
    let mut apps = Vec::new();
    for app_type in global_proxy_startup_app_types() {
        if db
...
mod tests {
    ...
    #[tokio::test]
    async fn startup_restore_excludes_enabled_grokbuild_route() {
